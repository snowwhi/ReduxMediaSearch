...
const ResultCard = ({ item }) => {
    ...
    return (
        <div className='w-[18vw] relative h-60 bg-white rounded-xl overflow-hidden'>
            ...
            <div id='bottom' className='flex justify-between  items-center w-full px-4 py-6 absolute bottom-0 text-white'>
